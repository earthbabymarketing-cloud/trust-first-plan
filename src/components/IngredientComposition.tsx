  ...
  return (
    <div className="mt-5 rounded-2xl border border-border bg-[color:var(--wash-sky)] overflow-hidden">
      ...
      <div className="px-4 py-4 sm:px-6">
        <div className="hidden sm:grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1.2fr)] gap-3 text-[11px] uppercase tracking-wider text-muted-foreground pb-2 border-b border-border">
        ...
        <ul className="divide-y divide-border">
          {data.rows.map((r) => (
            <li
              key={r.ingredient}
              className="py-2.5 sm:grid sm:grid-cols-[minmax(0,1fr)_auto_minmax(0,1.2fr)] sm:gap-3 sm:items-start"
            >
              <div>
