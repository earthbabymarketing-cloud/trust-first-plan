...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Caveat:wght@500;600&family=Livvic:wght@400;600;700&family=Nunito:wght@400;500;600;700&family=Abel&display=swap" },
    ],
  }),
