...
export const compositions: Record<string, Composition> = {
  ...
  "baby-wash": {
    ...
    rows: [
      ...
      { ingredient: "Xanthan Gum", composition: 1, naturalOriginPct: 100, function: "Thickening agent and stabiliser", natural: true },
      { ingredient: "Glyceryl Oleate", composition: 1, naturalOriginPct: 100, function: "Skin-conditioning co-emulsifier", natural: true },
      { ingredient: "Acacia Senegal Gum", composition: 1, naturalOriginPct: 100, function: "Natural thickener", natural: true },
